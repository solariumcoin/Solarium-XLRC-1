...
# Solarium Masternode Setup Guide (Ubuntu 16.04)
This guide will assist you in setting up a Solarium Masternode on a Linux Server running Ubuntu 16.04. (Use at your own risk)
...
`wget -q https://raw.githubusercontent.com/Realbityoda/Solarium-XLRC/master/solarium_install.sh`
***

***Step 8***
* Paste the code below into the Bitvise terminal then press enter

`bash solarium_install.sh`
...
***Step 2***
* Send EXACLY 10,000 XLRC to a receive address within your wallet.
***
...
`solarium-cli masternode status`
